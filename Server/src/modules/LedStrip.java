...
public class LedStrip extends ModulePattern {
    ...
    public void sendByteCode(byte[] code) {
        try {
            ...
            logError(STRINGS.log_led_strip_timeout); // TODO : check it.
        }
        catch (IOException e) {
            Logger.log(Logger.LevelSEVERE, ModuleLoader.class.getName(), e.getMessage());
            logError(e.getMessage()); // TODO : check it.
        }
        finally {
            try {
                if(writer != null)
    ...
    public void turnOn() {
        ...
        logSuccess(STRINGS.log_led_strip_on);
    }
    ...
    public void turnOff() {
        ...
        logSuccess(STRINGS.log_led_strip_off);
    }
    ...
    public void turnGreen() {
        ...
        logSuccess(STRINGS.log_led_strip_green);
    }
    ...
    public void turnCyan() {
        ...
        logSuccess(STRINGS.log_led_strip_cyan);
    }
    ...
    public void turnMagenta() {
        ...
        logSuccess(STRINGS.log_led_strip_magenta);
    }
    ...
    public void turnWhite() {
        ...
        logSuccess(STRINGS.log_led_strip_white);
    }
}
